...
contract MCR
{
    ...
    function addMCRData(uint mcrP , uint mcrE , uint vF ,bytes16[] curr ,uint[] rates , uint onlyDate , uint yearMonth)
    {
        ...
        //15678,200000000,1500000,["ETH","USD","EUR","GBP"],[100,200,300,400],20170708,201708
        //18100,10800,4,["ETH","USD","EUR","GBP"],[100,24403,21439,19089],20170708,201707
        ...
        //  td1=NXMTokenData(tokenDataAddress);
        // if(mcrP > 18000 && ( (now - td1.getLastDistributionTime())  > td1.getsdDistributionTime() * 1 days) )
        // {
