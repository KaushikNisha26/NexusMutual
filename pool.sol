...
contract pool is usingOraclize{
    ...
    function closeClaimsOraclise(uint id , uint time) onlyInternal
    {
        ...
        bytes32 myid1 = oraclize_query(time, "URL","http://43.242.214.177/nexusmutual-api/api/claims/closeClaim",3000000);
    ...
    function closeProposalOraclise(uint id , uint time) onlyInternal
    {
        ...
        bytes32 myid2 = oraclize_query(time, "URL","http://43.242.214.177/nexusmutual-api/api/claims/closeClaim",4000000);
    ...
    function closeQuotationOraclise(uint id , uint time) onlyInternal
    {
        ...
        bytes32 myid3 = oraclize_query(time, "URL","http://43.242.214.177/nexusmutual-api/api/claims/closeClaim",1500000);
    ...
    function closeCoverOraclise(uint id , uint time) onlyInternal
    {
        ...
        bytes32 myid4 = oraclize_query(time, "URL","http://43.242.214.177/nexusmutual-api/api/claims/closeClaim",1500000);
		saveApiDetails(myid4,"cover",id);
      
    }
    function versionOraclise(uint version) onlyInternal
    {
        bytes32 myid5 = oraclize_query("URL","http://43.242.214.177/nexusmutual-api/api/mcr/setlatest/P");
    ...
    function MCROraclise(uint time) onlyInternal
    {
        ...
        bytes32 myid4 = oraclize_query(time, "URL","http://43.242.214.177:444/mcrCalculation");
    ...
    {
        bytes32 apiid = oraclize_query("URL",strConcat("http://43.242.214.177/nexusmutual-api/api/pricing/getEarthquakeRisk/",bytes16ToString(lat),"/",bytes16ToString(long),""),1500000); 
